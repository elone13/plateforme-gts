            ...
            <div class="flex items-center justify-between h-16">
                ...
                <div class="flex items-center space-x-4">
                    ...
                    <nav class="hidden md:flex space-x-8">
                        ...
                        <a href="{{ route('client.factures') }}" class="text-gts-primary border-b-2 border-gts-primary px-3 py-2 text-sm font-medium transition-colors duration-200">
                            Factures
                        </a>
    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8" style="padding-top: 8rem; margin-top: 2rem;">
        ...
        <div class="mb-8">
            <div class="flex items-center justify-between">
                <div>
                    <h2 class="text-3xl font-bold text-gray-900 mb-2">Mes Factures</h2>
                    <p class="text-lg text-gray-600">Consultez et téléchargez vos factures</p>
                </div>
                <div class="flex space-x-3">
                    <button class="btn-gts-primary inline-flex items-center px-6 py-3 rounded-xl">
        ...
        <div class="bg-white rounded-2xl shadow-sm border border-gray-100 p-12">
            <div class="text-center">
                ...
                <h3 class="text-xl font-medium text-gray-900 mb-2">Aucune facture</h3>
                <p class="text-gray-600 mb-8">Vous n'avez pas encore de factures dans votre espace client.</p>
